...
const GameFlag = () => {
    ...
    let answerList:Array<string> = flagAnswerList
    const RANDOMNUMLIST = useState<Array<number>>([...Array(flagNumber)].map((v,i) => i).sort(() => Math.random() - 0.5))
    ...
    return (
        <S.GameMainLayout>
            ...
            <S.QuizImg src={require(`../../../assets/flagItem/${CurrentQuizNum}.jpg`)}/>

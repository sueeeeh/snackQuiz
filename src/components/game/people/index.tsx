...
const GamePeople = () => {
    ...
    let answerList:Array<string> = peopleAnswerList
    const RANDOMNUMLIST = useState<Array<number>>([...Array(peopleNumber)].map((v,i) => i).sort(() => Math.random() - 0.5))
    ...
    return (
        <S.GameMainLayout>
            ...
            <S.QuizImg src={require(`../../../assets/peopleItem/${CurrentQuizNum}.jpg`)}/>
            ...
            <S.GameInfoRow>
                ...
                <S.InfoBox> 
                    ...
                    {AnswerCount.toString().padStart(3,'0')}/{peopleNumber.toString().padStart(3,'0')}
                </S.InfoBox>
            </S.GameInfoRow>
